...
const ReasonwiseDropoutAnalysis = ({
  ...
  useEffect(() => {
    ...
    fetch(
      `https://shiksha-sanjivani-admin.onrender.com/FilterStudentinGroup/Reasons?state=${selectedState}&district=${selectedDistrict}&city=${selectedCity}&taluka=${selectedTaluka}&school`,
      requestOptions
    )
