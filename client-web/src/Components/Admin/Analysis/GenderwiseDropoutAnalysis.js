...
const GenderwiseDropoutAnalysis = ({
  ...
  useEffect(() => {
    ...
    fetch(
      `https://shiksha-sanjivani-admin.onrender.com/FilterStudentinGroup/Gender?state=${selectedState}&district=${selectedDistrict}&city=${selectedCity}&taluka=${selectedTaluka}&school`,
      requestOptions
    )
