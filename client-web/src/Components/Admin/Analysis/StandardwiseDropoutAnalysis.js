...
const StandardwiseDropoutAnalysis = ({
  ...
  useEffect(() => {
    ...
    fetch(
      `https://shiksha-sanjivani-admin.onrender.com/FilterStudentinGroup/Standard?state=${selectedState}&district=${selectedDistrict}&city=${selectedCity}&taluka=${selectedTaluka}&school`,
      requestOptions
    )
